...
from twmacl.phase3_runner import SCHEMA_VERSION, run_phase3


def _build_smoke_config(output_root: str):
    config = load_phase3_config("configs/phase3.yaml")
...
def main() -> int:
    output_root_a = Path("outputs/phase3_validation_a")
    output_root_b = Path("outputs/phase3_validation_b")
